            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', gap: 0.75, mt: 1 }}>
                ...
                <Chip 
                  ...
                  variant="outlined"
                  icon={
                    pond.health === 'Good' ? <CheckIcon sx={{ fontSize: '14px !important' }} /> : 
                    pond.health === 'Poor' ? <WarningIcon sx={{ fontSize: '14px !important' }} /> : undefined
                  }
                  sx={{ height: 22, fontSize: '0.7rem' }}
                />
              </Box>
            ...
            <Box sx={{ mb: 1.5 }}>
              ...
              <Tooltip title={`${pond.progress}% complete`} placement="top">
                <LinearProgress 
                  ...
                  value={pond.progress} 
                  color={
                    pond.progress > 70 ? 'success' : 
                    pond.progress > 40 ? 'warning' : 'error'
                  }
                  sx={{ 
                    height: 6, 
                    borderRadius: 3,

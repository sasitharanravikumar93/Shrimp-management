    ...
    >
        ...
        <Box sx={{ px: 2, pb: 1.5 }}>
          ...
          >
            {seasons && seasons.length > 0 ? (
              ...
              <MenuItem disabled value="">No Seasons Found</MenuItem>
            )}
          </TextField>
        </Box>
      )}
                ...
                >
                  ...
                  {!isSidebarCollapsed && (
                    <>
                      ...
                      />
                      {item.subItems && (
                        openPondMenu ? <ExpandLessIcon sx={{ fontSize: 18 }} /> : <ExpandMoreIcon sx={{ fontSize: 18 }} />
                      )}
                    </>
                  )}
                </ListItem>
      ...
      <List sx={{ px: 0.5 }}>
        <Tooltip title={isSidebarCollapsed ? 'User Account' : ''} placement="right" arrow>
          ...
          >
            <ListItemIcon sx={{ minWidth: isSidebarCollapsed ? 'auto' : 40, color: 'text.secondary' }}>
              <AccountIcon />
            </ListItemIcon>
            {!isSidebarCollapsed && (
              <ListItemText 
        ...
        <Toolbar>
          ...
          <Tooltip title="Notifications">
            <IconButton color="inherit" onClick={handleNotifOpen}>
              <Badge badgeContent={2} color="error" sx={{ '& .MuiBadge-badge': { fontSize: '0.65rem', height: 18, minWidth: 18 } }}>
                <NotificationsIcon />
              </Badge>
            </IconButton>
          </Tooltip>

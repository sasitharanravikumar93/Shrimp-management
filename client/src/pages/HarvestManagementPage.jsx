            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DatePicker
                    ...
                    onChange={date => setHarvestForm({ ...harvestForm, date })}
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  type='number'
                  required
                  value={harvestForm.totalBiomass}
                  onChange={e => setHarvestForm({ ...harvestForm, totalBiomass: e.target.value })}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
                  ...
                  type='number'
                  required
                  value={harvestForm.finalABW}
                  onChange={e => setHarvestForm({ ...harvestForm, finalABW: e.target.value })}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={e => setSaleForm({ ...saleForm, pricePerKg: e.target.value })}
                />
              </Grid>
              <Grid item xs={12}>
                <TextField
